...
Die "American Spaces" fördern das Verständnis für die Kultur, Politik, Lifestyle
der USA weltweit.
...
Es dient ebenso zur Authentifizierung mittels Single Sign-On.
    
Als Plugin verwenden wir Dancer::Plugin::LDAP.
