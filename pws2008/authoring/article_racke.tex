...
Die Parameter werden also wie die Daten aus einem HTML-Formular übergeben.
Für den Parameter \verb/id/ geschieht das unnötigerweise, da die
REST-Schnittstelle genauso die URI 
\verb%http://support.linuxia.de/rt/REST/1.0/user/racke/show% akzeptiert.
