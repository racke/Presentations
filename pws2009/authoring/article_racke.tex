...
Für RT 3.8 wurde die interne Aufbereitung der Emails komplett
überarbeitet, um Benutzern eine \WSIndex{WYSIWYG}-Eingabe zur Verfügung
zu stellen. Antworten, Kommentare und neue Tickets können damit
eine Formatierung erhalten, z.B. fett, rot oder eine bestimmte
Schriftart bzw. -größe. Ebenfalls wurde die Anzeige von HTML
und Multipart-Emails gründlich überholt.

Wegen seiner ausgezeichneten Cross-Plattform-Unterstützung wird dafür
...
aus denen leicht ein Backport für Etch oder Lenny erstellt werden
kann.
...
Cronjobs werden benötigt für den Versand von Digests, Dashboards
