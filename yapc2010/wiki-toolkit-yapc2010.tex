...
% \section{Preface}
\note{Welcome to my presentation about Wiki::Toolkit, a toolkit for building
Wikis with Perl.
...
\verb+Wiki::Toolkit::Store::MediaWiki+ uses a Mediawiki 1.6 database running
in MySQL. This module is intended to be capable of running concurrently
with a Mediawiki 1.6 installation without data corruption. 
...
All storage backends with the exception of the MediaWiki one can be easily
initialized with the corresponding \verb+Wiki::Toolkit::Setup+ classes.
