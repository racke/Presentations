...
\title{Template::Flute - Modern HTML and PDF Engine}
\author[racke]{Stefan Hornburg (Racke)\\ \texttt{racke@linuxia.de}}
\date[]{Perl Mongers Hamburg, 4th April 2011}
...
\subsection{Template::Flute::Iterator}
...
\subsubsection{Specification with sort}
...
\begin{frame}{The End}
 \begin{description}
  \item[Git] git://git.linuxia.de/temzoo.git
  ...
  \item[Talk]
    \url{http://www.linuxia.de/talks/hhmongers2011/tf-hhmongers2011-beamer.pdf}
   \item[Questions] ???
 \end{description}
\end{frame}
