...
abhängig von der Organisation oder der Person, die die Emails empfängt.
Daher kommt es zu Fehlerkennungen, False Positives und False Negatives.

False Positives sind Emails, die fälschlich als SPAM behandelt wurden,
während False Negatives SPAMs sind die den Filter überwunden haben.
