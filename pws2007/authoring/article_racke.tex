...
Das Löschen von Emails auf einen IMAP-Server kann man nicht mit dem
Löschen einer Datei auf einem Linux-System vergleichen. Emails werden
zunächst nur zum Löschen markiert. 

Die \verb/delete_message/-Methode führt das folgende IMAP-Kommando aus:
