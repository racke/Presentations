...
und potentiell schädlicher Post unterzugehen, wenn Gegenmaßnahmen
...
\item ClamAV erkennt Malware aller Art, darunter auch \WSIndex{Phishing} und
  \WSIndex{Trojaner}
\item Emails mit Viren können durch IMAP-Befehle ins Postfach gelangen
\end{itemize}
...
\subsubsection{SpamAssassin}
Für die Erstellung von Statistiken der SPAM/HAM-Verteilung gibt es zwei
...
Beide untersuchen
Emaillogdateien (gewöhnlich \verb%/var/log/mail.info%) auf Einträge 
des SpamAssassin-Dämons \verb/spamd/.
Verkürzt dargestellt sehen die Einträge wie folgt aus:
