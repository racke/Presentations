...
\begin{frame}{LDAP Directory - Hierarchy}
\begin{description}
\item[Region] EUR
...
\end{description}
%\begin{lstlisting}
%dn: ou=American Library Kyiv,ou=Ukraine,ou=EUR,ou=institutes,dc=interchange,dc=at
%\end{lstlisting}
\end{frame}
...
\begin{frame}[fragile]{eShop: Solr / Ajax}
\begin{itemize}
\item Products
\item Partners
\item Collections
