...
\begin{frame}[fragile]{Upload Routes}
\begin{lstlisting}
post '/home/**' => sub {
    my ($parts) = splat;
    my $path_relative = join('/', @$parts);
...
\begin{frame}[fragile]{before\_template\_render}
\begin{lstlisting}
...
\subsection{404}
\begin{frame}[fragile]{404}
\begin{itemize}
\item public/404.html
\item 
\begin{lstlisting}
any qr{.*} => sub {
    status 'not_found';
...
\subsection{500}
\begin{frame}[fragile]{500}
\begin{itemize}
\item public/500.html
\item error\_template
\end{itemize}
\end{frame}
